<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql_string = 'UPDATE transactions SET (vip_name, transactiondate, transactionamount) values (vip_name, transactiondate, transactionamount) WHERE where transactionid='.$_GET["transactionid"]''; 
